...
fig_fold="figure_cc/"
name="cc_all_and_sing_x1_serial"
run_type="normal"
...
for m in {1..120}; do
    ...
    srun --exclusive --nodes 1 --ntasks 1 python3 -u ClusterEmcee2_linear_mu_all_and_single_fast.py $fits $start_row $next_row $run_type $name $fig_fold > x1_runlogs/cc_allandsing_x1_"$start_row"_"$next_row".txt 2>&1 &
done
wait
