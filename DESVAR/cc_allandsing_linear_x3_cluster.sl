...
first_row=60000
last_row=120000  #209392 #120000 #121658
delta=$((( last_row - first_row ) / (SLURM_NTASKS)))
fig_fold="figure_cc/"
name="cc_all_and_sing_x3_serial_cluster"
run_type="normal"
...
for m in {1..120}; do
    ...
    srun --exclusive --nodes 1 --ntasks 1 python3 -u ClusterEmcee2_linear_mu_all_and_single_fast.py $fits $start_row $next_row $run_type $name $fig_fold > x3_runlogs_cluster/cc_allandsing_cluster_x3_"$start_row"_"$next_row".txt 2>&1 &
done
wait
